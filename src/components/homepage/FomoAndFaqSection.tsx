...
const FAQSection: React.FC = () => {
  ...
  <div className="inline-block relative mb-8">
    ...
    <div className="relative bg-gray-900/80 backdrop-blur border border-emerald-500/30 rounded-lg px-8 py-6">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-2xl mx-auto">
        {/* Call Button */}
        <a
          href="tel:+919962107102"
          className="flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-700 hover:to-teal-600 transition-all duration-300 text-white font-bold py-3 px-6 rounded-lg text-lg shadow-lg shadow-emerald-500/20 border border-emerald-400/30 relative overflow-hidden group text-center"
        >
        ...
        <a
          ...
          className="flex-1 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 transition-all duration-300 text-white font-bold py-3 px-6 rounded-lg text-lg shadow-lg border border-emerald-400/30 relative overflow-hidden group text-center"
        >
  ...
  {/* Final CTA Button - Scroll Up 200px */}
  <div className="mt-8 text-center">
    <button
      onClick={() => window.scrollBy({ top: -400, behavior: 'smooth' })}
      className="bg-gradient-to-r from-amber-500 to-red-500 hover:from-amber-600 hover:to-red-600 transition-all duration-300 text-white font-bold py-3 px-8 rounded-full text-lg shadow-lg shadow-amber-500/20 relative overflow-hidden group"
    >
      <div className="absolute inset-0 w-1/3 bg-white/20 skew-x-12 group-hover:translate-x-96 transition-transform duration-700"></div>
